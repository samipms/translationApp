...
export const BrushOptionPane: React.FC = ({}): JSX.Element => {
    ...
    const [recentBrushSizes, setRecentBrushSizes] = useState<number[]>([]);
        ...
        <>
            {isDialogVisible && (
                <Stack className={styles.container}>
                    {/* TODO figure out UI for brush size history
                {dialogsContext.state.isBrushOptionPaneVisible && (
                    <Stack>
                        <SizeSlider
                        ...
                        />
                        <Stack horizontal>
                            {recentBrushSizes.map((b, idx) => {
                                return (
                                    <DefaultButton
                                        className={styles.brushSizeSelections}
                                        key={idx}
                                        onClick={() => {
                                            setBrushSize(b);
                                        }}
