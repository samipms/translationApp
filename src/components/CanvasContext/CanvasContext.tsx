...
import { PaintStorageManager } from '../../paint-storage-manager/get-paint-storage-manager';
...
export type CanvasState = {
    ...
    paintHistory?: PaintHistory | undefined | null;
    brushColor: IColor;
    fillColor: IColor;
    shapeColor: IColor;
    brushSize: number;
    ...
    shapeSize: number;
    activeTool: ToolType;
    paintStorageManager?: PaintStorageManager;
...
export type CanvasAction =
    ...
    | { type: 'setPaintHistory'; value: PaintHistory | undefined | null }
    ...
    | { type: 'setPaintStorageManager'; value: PaintStorageManager }
...
export const CanvasReducer = (
    ...
    switch (action.type) {
        ...
        case 'setCanvasRef':
            ...
            return newState;
        case 'setPaintHistory':
            newState.paintHistory = action.value;
            return newState;
        case 'setActiveTool':
        ...
        case 'setColor':
            ...
            return newState;
        case 'setPaintStorageManager':
            newState.paintStorageManager = action.value;
            return newState;
        case 'setTextSize':
